...
\begin{tikzpicture}% table
  \begin{axis}[xlabel={\textsf{Cumulative oracle calls}}, ylabel=$f(x_k) - f^{\ast}$, ymode=log,
               ...
               legend entries={{\texttt{SuperPolyak}},
                               {\texttt{PolyakSGM}}}]
  \addlegendimage{mark=square*, very thick, solid};
  \addlegendimage{no markers, very thick, dashed};
  \addplot[mark=square*, very thick, color=black] table[x=cumul_oracle_calls,y=fvals, col sep=comma]
  ...
  \addlegendimage{mark=square*, very thick, solid};
  \addlegendimage{no markers, very thick, dashed};
  \addplot[mark=square*, very thick, color=black] table[x=cumul_elapsed_time,y=fvals, col sep=comma]
    {./matrix_sensing_32768_2_16_100_bundle.csv};
